...
struct Value *ParseFunctionDefinition(struct ParseState *Parser, struct ValueType *ReturnType, char *Identifier) {
    ...
    FuncValue = VariableAllocValueAndData(pc, Parser, sizeof(struct FuncDef) + sizeof(struct ValueType *) * ParamCount +
                                                      sizeof(const char *) * ParamCount, FALSE, NULL, TRUE);
    ...
    FuncValue->Val->FuncDef.ParamName = (char **) ((char *) FuncValue->Val->FuncDef.ParamType +
...
void ParseMacroDefinition(struct ParseState *Parser) {
    ...
    if (!TableSet(Parser->pc, &Parser->pc->GlobalTable, MacroNameStr, MacroValue, (char *) Parser->FileName,
